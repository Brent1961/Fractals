...
public class JuliaBulb extends NodeObject
{
    public class FData {
        int x, y, z, w;
    ...
    public JuliaBulb() {}
    public JuliaBulb (float x, float y, float v, float w, Node node)
    {
        super(x,y,v,w,node);
        this.x=x;
        this.y=y;
        ...
        this.x=-1.25f; this.y=-1.25f; this.z=-1.25f;
        xscale=100; yscale=100; zscale=100; increm=0.0125f;
    ...
    */
        ...
        if (z>=1.25f)
        {
            ...
            System.out.println("vertices: "+vcount+"  faces: "+fcount);
            System.out.println("fps: "+node.framesPerSecond);
            out.println("# faces: "+fcount+"   vertices: "+vcount);
            out.close();
            node.stop();
        }
    }
